...
await connection.query('CREATE DATABASE IF NOT EXISTS blinkchat');
await connection.query('USE blinkchat');
console.log('✅ Database "blinkchat" ready');
...
`);
console.log('✅ Table: conversation_participants');
...
console.log('\n🎉 BlinkChat database migration complete!');
